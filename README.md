...
[BBGsymbols](https://github.com/bautheac/BBGsymbols/) provides a
...
The `fields` dataset gathers common Bloomberg query fields. It provides
...
The `tickers_cftc` dataset gathers Bloomberg position data tickers for a
number of futures series. These tickers allow direct retrieval from
Bloomberg via the [pullit](https://github.com/bautheac/pullit/) package
...
The `tickers_futures` dataset gathers futures active contract Bloomberg
...
Although [BBGsymbols](https://github.com/bautheac/BBGsymbols/) is
self-contained it belongs to the
[finRes](https://bautheac.github.io/finRes/) suite of packages where it
plays an important role in providing support to the
[pullit](https://github.io/bautheac/pullit/) and
[storethat](https://github.io/bautheac/storethat/) packages for
collecting financial data from Bloomberg and storing it locally as well
as updating it and eventually retrieving it where/when a Bloomberg
